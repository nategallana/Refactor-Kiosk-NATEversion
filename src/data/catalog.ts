...
const useFixtures = (import.meta as unknown as Record<string, Record<string, string>>).env?.MODE === 'test' || (import.meta as unknown as Record<string, Record<string, string>>).env?.VITE_USE_FIXTURES === 'true'
export const catalogRepository = useFixtures ? new FixtureCatalogRepository() : new ApiCatalogRepository()
